...
namespace Vfi.Ui.Mvc.Vfi.Areas.Purchasing.Models
{
    ...
    public class PrintEvaluationForm {
        ...
        public string EvaluationStr {
            get {
                return "EVALUATION " + Year + " " + StatusStr;
            }
        }
        ...
        //    get {
        //        return "Delivery Performance (Times)";
        //    }
        //}

        //public string DeliveryDemerit {
        //    get {
        //        return "Delivery Demerit (Times)";
        //    }
        //}
        ...
        public string ObjectiveNextYear {
            get {
                return "OBJECTIVES " + NextYear + ":";
            }
        }

        public string LateTimesStr {
            get{
                return LateTimes + " / " + TotalOrder;
            }
        }

        public string LessTimesStr {
            get {
                return LessTimes + " / " + TotalOrder;
            }
        }

        public string NGTimesStr {
            get {
                return NGTimes + " / " + TotalOrder;
            }
        }


        public string PercentNGQuantityStr{
            get {
                return PercentNGQuantity + "%";
            }
        }
