...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new Vfi.Ui.Mvc.Vfi.Areas.Inv.Reports.RptEvaluationForm();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPagePrintEvationForm.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageRptEvaluationForm" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
