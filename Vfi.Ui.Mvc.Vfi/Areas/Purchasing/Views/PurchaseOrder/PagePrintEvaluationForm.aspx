...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new Vfi.Ui.Mvc.Vfi.Areas.Inv.Reports.RptPrintEvaluationForm();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPagePrintEvaluationForm.Report = rp;
...
<telerik:ReportViewer ID="rptvPagePrintEvaluationForm" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
